                ...
                <div class="col-lg-8 mt-30">
                    <div class="blog-post-wrap mt-none-30">
                        <article class="blog__item mt-30">
                            <a class="thumb" href="blog-single.html"><img
                                    src="{{ asset('assets/web/assets/img/blog/post_01.jpg') }}" alt="">
                                alt=""></a>
                            <div class="blog__inner">
                                ...
                                <h2 class="title border_effect"><a href="blog-single.html">Examining the Rise,
                                ...
                                <p>Our ICO presents a unique opportunity to embark on a journey into the crypto
                                    frontier, where groundbreaking ideas and technological advancements
                                    converge. </p>
                        ...
                        <article class="blog__item mt-30">
                            <a class="thumb" href="blog-single.html"><img
                                    src="{{ asset('assets/web/assets/img/blog/post_04.jpg') }}"
                                    alt="
                                    alt=""></a>
                            <div class="blog__inner">
                                ...
                                <h2 class="title border_effect"><a href="blog-single.html">From Concept to
                                        Reality Discover the Journey of Our ICO Project</a></h2>
                                <p>we stand on the threshold of a significant milestone: our ICO campaign. This
                                    phase represents the culmination of our efforts an opportunity for you to be
                        ...
                        <article class="blog__item mt-30">
                            <a class="thumb" href="blog-single.html"><img
                                    src="{{ asset('assets/web/assets/img/blog/post_03.jpg') }}"
                                    alt="
                                    alt=""></a>
                            <div class="blog__inner">
                                <ul class="blog__meta ul_li mb-30">
                                ...
                                <h2 class="title border_effect"><a href="blog-single.html">ICO Launchpad Your
                                        Gateway to Exciting Investment Opportunities</a></h2>
                                <p>The world of blockchain and cryptocurrency is dynamic and ever-evolving. As
                                    traditional <br> boundaries shift, new avenues for growth emerge. Our ICO
                                    Launchpad is your.</p>
                                <a class="blog-btn" href="blog-single.html">Read MOre</a>
                            </div>
                        </article>
                        <article class="blog__item mt-30">
                            <a class="thumb" href="blog-single.html"><img
                                    src="{{ asset('assets/web/assets/img/blog/post_02.jpg') }}"
                                    alt="
                                    alt=""></a>
                            <div class="blog__inner">
                                <ul class="blog__meta ul_li mb-30">
                                ...
                                <h2 class="title border_effect"><a href="blog-single.html">ICO Revolution
                                        Investing in Blockchain Solutions for a Decentralized World</a></h2>
                                <p>Welcome to the ICO Revolution, where your investments have the power to
                                    reshape <br> industries and drive the transformation towards a decentralized
                                    future.</p>
                                <a class="blog-btn" href="blog-single.html">Read MOre</a>
                            </div>
                        </article>
