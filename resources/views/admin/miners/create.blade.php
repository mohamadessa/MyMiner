            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">Add minser</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" action="{{ route('miners.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" id="hash" name="hash" class="form-control" placeholder="hash">
                                                @error("hash")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="power" name="power" class="form-control" placeholder="power">
                                                @error("power")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="hash" name="hash" class="form-control" placeholder="hash">
                                                @error("hash")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="cooling" name="cooling" class="form-control" placeholder="cooling">
                                                @error("cooling")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="temp" name="temp" class="form-control" placeholder="temp">
                                                @error("temp")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="revenue" name="revenue" class="form-control" placeholder="revenue">
                                                @error("revenue")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
