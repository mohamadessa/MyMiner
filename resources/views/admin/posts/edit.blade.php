            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" action="{{ route('posts.update',['post'=>$post]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" value="{{ $post->title }}" name="title" class="form-control" placeholder="title">
                                                @error("title")
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <img src="{{ asset('storage/'.$post->image) }}" alt="Post Image" width="100%" height="100%">
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="excerpt" name="excerpt" placeholder="excerpt" class="form-control">{{ $post->excerpt }} </textarea>
                                            @error("excerpt")
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="body" name="body" placeholder="body" class="form-control"> {{ $post->body }}</textarea>
                                            @error("body")
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ now()->format('Y-m-d') }}" value="{{ $post->published_at }}" id="published_at" name="published_at" class="form-control" placeholder="published_at">
                                            @error("published_at")
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
